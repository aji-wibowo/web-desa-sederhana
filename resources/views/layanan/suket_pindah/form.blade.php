                                ...
                                <tbody>
                                    @foreach ($riwayat as $r)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $r->status }} <?= $r->status == 'Siap Diambil' || $r->status == 'Selesai' ? "<a target='__blank' href='" . url('uploads/pdf/' . $r->pdf . '.pdf') . "'> | download surat pdf</a>" : '' ?></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                ...
                <div class="col-md-12 mt-5">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <small>Pembuatan Surat Keterangan Pindah Datang WNI</small>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                                {!! implode('', $errors->all('<div>:message</div>')) !!}
                            @endif
                            <form action="{{ route('layanan_pindah_datang_proses') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Kartu Keluarga <small style="color: red">*</small></label>
