                                ...
                                <tbody>
                                    @foreach ($riwayat as $r)
                                        <tr>
                                            ...
                                            <td>{{ $r->status }}
                                                <?= $r->status == 'Siap Diambil' ? "<a target='__blank' href='" . url('uploads/pdf/' . $r->pdf . '.pdf') . "'>download surat pdf</a>" : '' ?>
                                                                                                </td>
                                                                                            </tr>
                                                                                        @endforeach
                                                                                    </tbody>
                                                                ...
                                                                <div class="col-md-12 mt-5">
                                                                    <div class="card">
                                                                        <div class="card-header">
                                                                            ...
                                                                            <small>Pembuatan Kartu Keluarga</small>
                                                                        </div>
                                                                        <div class="card-body">
                                                                            @if ($errors->any())
                                                                                {!! implode('', $errors->all('<div>:message</div>')) !!}
                                                                            @endif
                                                                            <form action="{{ route('layanan_kk_proses') }}" method="POST" enctype="multipart/form-data">
                                                                                @csrf
                                                                                <div class="row">
                                                                                    <div class="col-md-6">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label>Kartu Tanda Penduduk <small style="color: red">*</small></label>
                                                                                            <input type="file" name="kartu_tanda_penduduk" class="form-control" required>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label>Ijasah Terakhir <small style="color: red">*</small></label>
                                                                                            <input type="file" name="ijasah_terakhir" class="form-control" required>
                                                                                        </div>
                                                                                        <div class="form-group">
