            ...
            <div class="col-md-6" style="margin: auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('profil_admin_proses') }}" method="POST" enctype="multipart/form-data"
                            autocomplete="off">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" id="password" name="password_baru" class="form-control mt-2"
                                    placeholder="Password baru Anda">
                            </div>
                            @if (Auth::user()->role == 'warga')
                                <div class="form-group">
                                    <label>Foto Identitas</label>
                                    <img src="{{ url($data->identity_file) }}" alt="{{ $data->identity_file }}"
                                        width="40%">
                                </div>
                            @endif
