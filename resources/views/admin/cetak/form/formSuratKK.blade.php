            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('form_cetak_surat_kk', ['id' => $id]) }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="baruAtauGanti">PERMOHONAN KK</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="jumlahAnggotaKeluarga"
                                            value="{{ old('jumlahAnggotaKeluarga') }}">
                                    </div>
                                    <div class="form-group">
