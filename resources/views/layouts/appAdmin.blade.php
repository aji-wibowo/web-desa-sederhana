...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('pelayanan_admin') }}">{{ __('Pelayanan') }}</a>
                        </li>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{ route('list_user') }}">Pengguna</a>
                                <a class="dropdown-item" href="{{ route('rukun_warga') }}">Rukun Warga</a>
                                <a class="dropdown-item" href="{{ route('profil_admin') }}">Profil</a>
                            </div>
                        </div>
                    </ul>
    ...
    <!-- Datatable -->
    <script src="{{ url('/') }}/plugins/datatables/jquery.dataTables.min.js" defer></script>
    <script src="{{ url('/') }}/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js" defer></script>
